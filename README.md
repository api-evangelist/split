...
- [JSONStructure](json-structure/split-feature-flag-structure.json)
...
- [JSONStructure](json-structure/split-feature-flag-definition-structure.json)
...
- [JSONSchema](json-schema/split-feature-flag-schema.json)
- [JSONSchema](json-schema/split-feature-flag-definition-schema.json)
- [JSONSchema](json-schema/split-segment-schema.json)
- [JSONStructure](json-structure/split-feature-flag-structure.json)
- [JSONStructure](json-structure/split-feature-flag-definition-structure.json)
- [JSON-LD](json-ld/split-context.jsonld)
- [SpectralRules](rules/split-rules.yml)
...
- [Split Admin API](capabilities/shared/split-admin-api.yaml)
- [Split Feature Flag API](capabilities/shared/split-feature-flag-api.yaml)
- [Split Evaluator API](capabilities/shared/split-evaluator-api.yaml)

### Workflow Capabilities

- [Feature Flag Management](capabilities/feature-flag-management.yaml) — Full lifecycle management combining Admin, Feature Flag, and Evaluator APIs (13 tools).
